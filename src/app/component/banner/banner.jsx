  ...
  return (
    <section className="relative w-full h-screen overflow-hidden">
      ...
      <div className="relative z-0 flex flex-col items-center justify-center h-full px-4">
        <h1 className="text-white md:text-5xl text-4xl font-bold text-center leading-tight">
          {banner.title}
        </h1>
        <h2 className="text-white md:text-5xl text-4xl pt-2 font-bold text-center leading-tight">
          {banner.subtitle}
        </h2>
